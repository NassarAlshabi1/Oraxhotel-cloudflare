...
class AppwriteConfig {
  ...
  // ═══════════════════════════════════════════════════════════════
  //  API key — لا يُضمّن أي مفتاح خادمي داخل التطبيق
  // ═══════════════════════════════════════════════════════════════
  // يبقى المسار القديم متاحاً للتوافق فقط. يجب تزويد المفتاح وقت التشغيل
  // عبر إعداد آمن، ولا يجوز وضع API key خادمي داخل APK أو المستودع.
