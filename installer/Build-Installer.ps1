...
# ============================================================================
# 2) بناء HotelSys.exe — نشر ذاتي على win-x64
# ============================================================================
if (-not $SkipAppBuild) {
    Write-Host ""
    Write-Host "[2/5] بناء HotelSys.exe (نشر ذاتي) ..." -ForegroundColor Yellow
    ...
    Write-Host "[2/5] تم تخطي بناء التطبيق" -ForegroundColor DarkGray
}
...
# ============================================================================
Write-Host ""
Write-Host "[3/5] تجهيز ملفات الحمولة ..." -ForegroundColor Yellow
...
# ============================================================================
Write-Host ""
Write-Host "[4/5] ضغط الحمولة إلى payload.7z ..." -ForegroundColor Yellow
...
if (-not $SkipInstallerBuild) {
    Write-Host ""
    Write-Host "[5/5] بناء OraxHotel-Setup.exe ..." -ForegroundColor Yellow
    ...
    Write-Host "[5/5] تم تخطي بناء المُثبّت" -ForegroundColor DarkGray
}
...
Write-Host "     - فحص/تشغيل خدمة SQL Server"
Write-Host "     - استخراج ملفات التطبيق إلى %LOCALAPPDATA%\OraxHotel"
Write-Host "     - استعادة قاعدة Hotel_alkheer من النسخة الاحتياطية"
Write-Host "     - كتابة appsettings.json بالكامل"
Write-Host "     - إنشاء حساب مشرف افتراضي"
Write-Host "     - إنشاء اختصار على سطح المكتب"
Write-Host "     - فتح منفذ 5080 في جدار الحماية"
Write-Host "     - تشغيل التطبيق وفتح المتصفح على http://localhost:5080"
Write-Host ""
Write-Host "للوضع التفاعلي (يدوي): OraxHotel-Setup.exe --interactive"
Write-Host "لتفاصيل إضافية:        OraxHotel-Setup.exe --verbose"
