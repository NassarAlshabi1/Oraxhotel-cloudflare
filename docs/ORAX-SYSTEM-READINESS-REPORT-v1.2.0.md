...
> الحالة الحالية: **جاهز للتسليم المشروط**. إصدار Windows مبني ومرفوع، والتكامل الخادمي مع Appwrite منفذ ومختبر عبر REST. يبقى اختبار القبول التنفيذي على Windows واختبار APK على جهاز Android أو iOS ضرورياً قبل اعتبار النظام معتمداً ميدانياً دون تحفظ.
...
| مثبت Windows شامل | مرفوع | [`OraxHotel-Setup.exe`](https://github.com/Nassaralshabi/oraxhotel2024/releases/download/windows-installer-v1.2.0/OraxHotel-Setup.exe) |
| حزمة Windows مع الوثائق | مرفوعة | [`OraxHotel-Windows-Package-v1.2.0.zip`](https://github.com/Nassaralshabi/oraxhotel2024/releases/download/windows-installer-v1.2.0/OraxHotel-Windows-Package-v1.2.0.zip) |
| ملف البصمة | مرفوع | [`SHA256SUMS.txt`](https://github.com/Nassaralshabi/oraxhotel2024/releases/download/windows-installer-v1.2.0/SHA256SUMS.txt) |
| GitHub Release | منشور | [`windows-installer-v1.2.0`](https://github.com/Nassaralshabi/oraxhotel2024/releases/tag/windows-installer-v1.2.0) |
...
| تشغيل EXE وتثبيت SQL Server | غير منفذ | يتطلب Windows x64 فعلياً وUAC وخدمة SQL Server |
...
يجب تنفيذ اختبار Windows على جهاز نظيف أو آلة افتراضية تتضمن Windows 10/11 x64. يتضمن الاختبار تشغيل EXE، قبول UAC، التحقق من تثبيت خدمة `MSSQL$SQLEXPRESS`، استعادة القاعدة، التأكد من وجود `dbo.AspNetUsers`، تشغيل التطبيق، تسجيل الدخول، فتح الوحدات الأساسية، ثم استدعاء `/api/appwrite/health` وعمليات المزامنة الأربع من جلسة مشرف.
